...
export function MasterProfileSection() {
  const t = useTranslations('MasterProfileSection')
          ...
          <div className="mb-16 md:mb-24">
            ...
            <h2 className="font-[var(--font-cormorant)] text-4xl md:text-5xl lg:text-6xl text-primary font-light tracking-wide leading-tight">
              {t.rich('titleMain', {
                ...
                spanAccent: (chunks) => <span className="italic font-medium text-accent">{chunks}</span>
              })}
            </h2>
          </div>
        </FadeInUp>
              ...
              <div className="bg-gradient-to-br from-primary to-[#1A2510] rounded-2xl p-8 md:p-10 shadow-xl relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <Star className="w-5 h-5 fill-accent text-accent" />
                    <span className="text-accent text-sm tracking-widest uppercase ml-2 font-semibold">
                      {t('awardBadge')}
                    </span>
                  </div>
            ...
            <div className="relative pl-4 md:pl-8 border-l border-muted/30 space-y-12 py-4">
              ...
              <FadeInUp delay={0.4}>
                <div className="relative group">
                  ...
                  <div className="pl-6">
                    <span className="text-accent text-sm font-bold tracking-widest mb-2 block">{t('timeline1Date')}</span>
                    <h4 className="text-xl text-primary font-serif mb-3">{t('timeline1Title')}</h4>
                    <p className="text-muted-foreground font-light leading-relaxed text-sm">
                      {t.rich('timeline1Desc', {
                        bold: (chunks) => <strong>{chunks}</strong>
                      })}
                    </p>
                  </div>
              ...
              <FadeInUp delay={0.5}>
                <div className="relative group">
                  ...
                  <div className="pl-6">
                    <span className="text-accent text-sm font-bold tracking-widest mb-2 block">{t('timeline2Date')}</span>
                    <h4 className="text-xl text-primary font-serif mb-3">{t('timeline2Title')}</h4>
                    <ul className="space-y-2 text-muted-foreground font-light text-sm">
                      <li>{t('timeline2List1')}</li>
                      <li>{t('timeline2List2')}</li>
                      <li>{t('timeline2List3')}</li>
                    </ul>
                  </div>
                </div>
              </FadeInUp>
              ...
              <FadeInUp delay={0.6}>
                <div className="relative group">
                  ...
                  <div className="pl-6">
                    <span className="text-accent text-sm font-bold tracking-widest mb-2 block">{t('timeline3Date')}</span>
                    <h4 className="text-xl text-primary font-serif mb-3">{t('timeline3Title')}</h4>
                    <p className="text-muted-foreground font-light leading-relaxed text-sm mb-2">
                      {t.rich('timeline3Desc', {
                        bold: (chunks) => <strong>{chunks}</strong>
                      })}
                    </p>
                  </div>
              ...
              <FadeInUp delay={0.7}>
                <div className="relative group">
                  ...
                  <div className="pl-6">
                    <span className="text-accent text-sm font-bold tracking-widest mb-2 block">{t('timeline4Date')}</span>
                    <h4 className="text-xl text-primary font-serif mb-3">{t('timeline4Title')}</h4>
                    <p className="text-muted-foreground font-light leading-relaxed text-sm">
                      {t.rich('timeline4Desc', {
                        bold: (chunks) => <strong>{chunks}</strong>
                      })}
                    </p>
                  </div>
