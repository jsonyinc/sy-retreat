...
export function ZoneCardsSection() {
  const t = useTranslations('ZoneCardsSection');

  const zones = [
    {
      id: "01",
      badge: t('zone1Badge'),
      enTitle: t('zone1EnTitle'),
      koTitle: t('zone1KoTitle'),
      img: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=800&q=80",
      alt: t('zone1Alt'),
      items: [
        { label: t('zone1Item1Label'), desc: t('zone1Item1Desc') },
        { label: t('zone1Item2Label'), desc: t('zone1Item2Desc') },
        { label: t('zone1Item3Label'), desc: t('zone1Item3Desc') },
      ],
      mood: { icon: "🍵", text: t('zone1MoodText') },
    },
    {
      id: "02",
      badge: t('zone2Badge'),
      enTitle: t('zone2EnTitle'),
      koTitle: t('zone2KoTitle'),
      img: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&fit=crop&w=800&q=80",
      alt: t('zone2Alt'),
      items: [
        { label: t('zone2Item1Label'), desc: t('zone2Item1Desc') },
        { label: t('zone2Item2Label'), desc: t('zone2Item2Desc') },
        { label: t('zone2Item3Label'), desc: t('zone2Item3Desc') },
      ],
      mood: { icon: "✨", text: t('zone2MoodText') },
    },
    {
      id: "03",
      badge: t('zone3Badge'),
      enTitle: t('zone3EnTitle'),
      koTitle: t('zone3KoTitle'),
      img: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=800&q=80",
      alt: t('zone3Alt'),
      items: [
        { label: t('zone3Item1Label'), desc: t('zone3Item1Desc') },
        { label: t('zone3Item2Label'), desc: t('zone3Item2Desc') },
        { label: t('zone3Item3Label'), desc: t('zone3Item3Desc') },
      ],
      mood: { icon: "🌿", text: t('zone3MoodText') },
    },
    {
      id: "04",
      badge: t('zone4Badge'),
      enTitle: t('zone4EnTitle'),
      koTitle: t('zone4KoTitle'),
      img: "https://images.unsplash.com/photo-1508672019048-805c876b67e2?auto=format&fit=crop&w=800&q=80",
      alt: t('zone4Alt'),
      items: [
        { label: t('zone4Item1Label'), desc: t('zone4Item1Desc') },
        { label: t('zone4Item2Label'), desc: t('zone4Item2Desc') },
        { label: t('zone4Item3Label'), desc: t('zone4Item3Desc') },
      ],
      mood: { icon: "🧘", text: t('zone4MoodText') },
    },
  ];
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-3 bg-[#F9F6F0] rounded-xl px-4 py-3">
                  ...
                  <p className="text-[#4a5d23] text-xs font-medium leading-relaxed">
                    <span className="text-[#C5A880]">{t('moodLabel')}</span>
                    {zone.mood.text}
                  </p>
                </div>
              </div>
