...
export function TopHeader() {
  ...
  // 동적 다국어 렌더링을 위해 컴포넌트 내부로 이동된 배열
  const languages: { code: LanguageCode; label: string; display: string }[] = [
    { code: "ko", label: t('langKo'), display: "KO" },
    { code: "en", label: t('langEn'), display: "EN" },
    { code: "vi", label: t('langVi'), display: "VI" },
  ]

  const navLinks = [
    { label: t('navMaster'), href: "#master" },
    { label: t('navSanctuary'), href: "#sanctuary" },
    { label: t('navProgram'), href: "#program" },
    { label: t('navPartnership'), href: "#business-inquiry" },
    { label: t('navInquiry'), href: "#business-inquiry" },
  ]
